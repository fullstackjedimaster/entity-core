...
AUTH0_MANAGEMENT_AUDIENCE= env("AUTH0_MANAGEMENT_AUDIENCE","https://dev-gttnobig6h3trkvm.us.auth0.com/api/v2/")
EC_MODEL_BASE_URL=env("EC_MODEL_BASE_URL", "https://entity-server.fullstackjedi.dev")