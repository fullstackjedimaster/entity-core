...
BEGIN
  ...
  EXECUTE format($sql$
    ...
    AS $fn$
    BEGIN
      INSERT INTO %1$I.entity(entity_name, entity_json)
      VALUES (p_entity_name, p_entity_json)
  ...
  EXECUTE format('ALTER FUNCTION %1$I.upsert_entity(TEXT, JSONB) OWNER TO %1$I', p_entity_schema);
  EXECUTE format('REVOKE ALL ON FUNCTION %1$I.upsert_entity(TEXT, JSONB) FROM PUBLIC', p_entity_schema);
  EXECUTE format('GRANT EXECUTE ON FUNCTION %1$I.upsert_entity(TEXT, JSONB) TO ec_app', p_entity_schema);
  EXECUTE format('GRANT EXECUTE ON FUNCTION %1$I.upsert_entity(TEXT, JSONB) TO %1$I', p_entity_schema);
  ...
  EXECUTE format($sql$
    ...
    BEGIN
      ...
      PERFORM %1$I.upsert_entity(entity_name, entity_json);
    END;
    $fn$
  $sql$, p_entity_schema);

  EXECUTE format('ALTER FUNCTION %1$I.create_entity( TEXT, JSONB) OWNER TO %1$I', p_entity_schema);
  EXECUTE format('REVOKE ALL ON FUNCTION %1$I.create_entity( TEXT, JSONB) FROM PUBLIC', p_entity_schema);
  EXECUTE format('GRANT EXECUTE ON FUNCTION %1$I.create_entity( TEXT, JSONB) TO ec_app', p_entity_schema);
  EXECUTE format('GRANT EXECUTE ON FUNCTION %1$I.create_entity( TEXT, JSONB) TO %1$I', p_entity_schema);
  ...
  EXECUTE format('ALTER FUNCTION %1$I.manage_entity(TEXT, TEXT, UUID, JSONB) OWNER TO %1$I', p_entity_schema);
  EXECUTE format('REVOKE ALL ON FUNCTION %1$I.manage_entity(TEXT, TEXT, UUID, JSONB) FROM PUBLIC', p_entity_schema);
  EXECUTE format('GRANT EXECUTE ON FUNCTION %1$I.manage_entity(TEXT, TEXT, UUID, JSONB) TO ec_app', p_entity_schema);
  EXECUTE format('GRANT EXECUTE ON FUNCTION %1$I.manage_entity(TEXT, TEXT, UUID, JSONB) TO %1$I', p_entity_schema);
  ...
  EXECUTE format('ALTER FUNCTION %1$I.get_column_options( TEXT, TEXT, TEXT) OWNER TO %1$I', p_entity_schema);
  EXECUTE format('REVOKE ALL ON FUNCTION %1$I.get_column_options( TEXT, TEXT, TEXT) FROM PUBLIC', p_entity_schema);
  EXECUTE format('GRANT EXECUTE ON FUNCTION %1$I.get_column_options( TEXT, TEXT, TEXT) TO ec_app', p_entity_schema);
  EXECUTE format('GRANT EXECUTE ON FUNCTION %1$I.get_column_options( TEXT, TEXT, TEXT) TO %1$I', p_entity_schema);
  ...
  EXECUTE format('ALTER FUNCTION %1$I.get_form_metadata( TEXT) OWNER TO %1$I', p_entity_schema);
  EXECUTE format('REVOKE ALL ON FUNCTION %1$I.get_form_metadata( TEXT) FROM PUBLIC', p_entity_schema);
  EXECUTE format('GRANT EXECUTE ON FUNCTION %1$I.get_form_metadata( TEXT) TO ec_app', p_entity_schema);
  EXECUTE format('GRANT EXECUTE ON FUNCTION %1$I.get_form_metadata( TEXT) TO %1$I', p_entity_schema);
